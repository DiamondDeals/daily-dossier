...
h+='<button onclick="if(confirm(\'Clear all saved items?\')){{sBm([]);sDay([]);rList();syncBtns()}}" style="padding:4px 8px;border-radius:8px;border:1px solid #ff453a;background:none;color:#ff453a;cursor:pointer;font-size:11px;">Clear All</button>';
h+='</div>';
